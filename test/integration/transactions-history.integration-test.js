    ...
    return runInServer(api =>
      api
        ...
        .expectBody([
          ...
          {
            hash:
              'a8fb2c6cce6d68ea4c65b8301eb26636178c40d3c65071e738d5a4e5cde4d91d',
            inputs_address: [
          ...
          {
            hash:
              'de5dbbed46ef5c69f52b3a77ee74585bef07aebcd90383de28348159c697b568',
            inputs_address: [
              'DdzFFzCqrhsgBCt25t6JArdDHfJZkzzebapE2qqrg1yoquLZzeEyxzhLAb9x7rVf5aby9jwLvL65hH9zTWjbekwzbeYCjJ5pUKn1rYgB',
            ],
        ...
        .expect(
          assertOnResults((res, body) => {
            ...
            expect(lastElem.hash).to.equal(
              '5fb8e0d9c67c85171fa7ed4b6b3626bca418bfe3161f3cb4f1c0bc3a4751f64b',
            );
            lastDateFrom = lastElem.time;
          }),
        )
        .end(),
    );
